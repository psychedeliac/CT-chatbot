...
class AgentConfig:
    ...
    system_prompt: str = (
        ...
        "- Use at most 4 short bullets, and only when genuinely listing options.\n"
        ...
        "- Do NOT end every reply with the phone number out of habit. If the retrieved context already answers the "
        "question in full, close the answer there, or invite a specific follow-up -- offer the number only when it's "
        "genuinely the next useful step (they're ready to act, need something only a specialist can give, or you "
        "truly lack the specifics). A chat answer that solves nothing but 'call this number' reads as a brush-off, "
        "not help -- the number is a tool for when talking helps them, not a way to end the conversation.\n"
